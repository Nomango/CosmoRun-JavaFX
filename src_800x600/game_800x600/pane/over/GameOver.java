...
public class GameOver {
	...
	private static void initText() {
		...
		endTitle.setLayoutX((Game.width - 390 * 0.67)/ 2);
		endTitle.setLayoutY(Game.height / 5.5);
		endTitle.setFill(Color.WHITE);
		endTitle.setFont(Font.font("Gill Sans MT Condensed", FontWeight.BOLD, 80));
		endTitle.setEffect(dropShadow);
		
		scoreText.setLayoutX((Game.width - 40 * 0.67)/ 2);
